...
public class UserResource {
	...
	@PostMapping// -> método JPA no resource para inserir um novo objeto no banco de dados
	...
	@DeleteMapping(value = "/{id}")//-> método JPA no resource para deletar um novo objeto no banco de dados
